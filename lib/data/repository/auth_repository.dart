...
abstract class AuthRepository {
  ...
  Future<Either<HttpException, ResponseModel>> confirmEmail(VerificationInput input);
}
...
class AuthRepositoryImpl extends AuthRepository {
  ...
  @override
  Future<Either<HttpException, ResponseModel>> confirmEmail(VerificationInput input) async {
    return await apiService.task<ResponseModel>(VerificationEndpoint(input));
  }
