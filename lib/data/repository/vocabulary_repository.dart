...
abstract class VocabularyRepository {
  Future<Either<HttpException, UserVocabularyModel>> getAllLearningWords(int page, int pageSize);
...
class VocabularyRepositoryImpl extends VocabularyRepository {
  ...
  Future<Either<HttpException, UserVocabularyModel>> getAllLearningWords(
    ...
    return await apiService.task(GetAllLearningWordsEndpoint(page: page, pageSize: pageSize));
  }
  ...
  //       .task(GetAllMasterWordsEndpoint(page: page, pageSize: pageSize));
  // }
}
