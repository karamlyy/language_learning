...
enum SettingsOption {
  languages(title: 'Languages', icon: CupertinoIcons.globe, route: Routes.changePassword),
  timing(title: 'Timing', icon: CupertinoIcons.clock, route: Routes.changePassword),
