  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: PageView.builder(
        ...
        itemCount: 2,
        controller: languageProvider.pageController,
        onPageChanged: (index) {
          languageProvider.pageIndex = index;
        },
        itemBuilder: (context, index) {
          return Column(
            children: [
              Header(
                onTap: () {
                  languageProvider.goToPreviousPage(languageProvider.pageIndex);
                },
              ),
              SetLanguageHeader(),
              SetLanguagesList(pageIndex: languageProvider.pageIndex),
              SetLanguageButton(),
            ],
          );
        },
